...
// NOTE TO SELF: THIS SCRIPT IS AN ADVANCED VERSION OF THE PLAYER MOVEMENT SCRIPT WITH DASHING FUNCTIONALITY ADDED
// THIS ALSO HAS THE DASHING FUNCTIONALITY FROM THE ORIGINAL PLAYER MOVEMENT SCRIPT
// DO NOT FUCK WITH THIS SCRIPT PLEASE :3 (IVE re WRITTEN IT 4 TIMES)
...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        if (Input.GetKeyDown(jumpKey) && readyToJump && doubleJump != null && doubleJump.CanJump())
        {
            readyToJump = false;
            Jump();
            doubleJump.UseJump();
